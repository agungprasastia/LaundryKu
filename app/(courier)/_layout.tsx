  ...
  return (
    <ProtectedRoute allowedRoles={['courier']}>
      ...
      >
        ...
        <Tabs.Screen name="tasks" options={{ title: 'Tugas', tabBarIcon: ({ color }) => <Ionicons name="list" size={22} color={color} /> }} />
        <Tabs.Screen name="earnings" options={{ title: 'Pendapatan', tabBarIcon: ({ color }) => <Ionicons name="cash" size={22} color={color} /> }} />
