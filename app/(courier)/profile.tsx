  ...
  return (
    <View style={s.c}>
      ...
      <View style={s.ct}>
        ...
        <Text style={s.n}>{user?.full_name || 'Kurir'}</Text>
        <Text style={s.e}>{user?.email || '-'}</Text>
        <View style={[s.rb, { backgroundColor: LaundryColors.roleKurirBg }]}>
          <Text style={[s.rbt, { color: LaundryColors.roleKurirIcon }]}>Kurir</Text>
        </View>
...
const s = StyleSheet.create({
  ...
  av:{width:72,height:72,borderRadius:36,backgroundColor:LaundryColors.roleKurirIcon,alignItems:'center',justifyContent:'center'},
