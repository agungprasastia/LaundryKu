...
export default function CourierTasksScreen() {
  return (<View style={s.c}><View style={s.h}><Text style={s.ht}>Tugas</Text></View><View style={s.ct}><Ionicons name="list" size={48} color={LaundryColors.primaryLight} /><Text style={s.t}>Daftar Tugas</Text><Text style={s.st}>Fitur tugas kurir akan segera hadir.</Text></View></View>);
}
