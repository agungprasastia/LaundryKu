...
export default function CourierWalletScreen() {
  return (<View style={s.c}><View style={s.h}><Text style={s.ht}>Wallet</Text></View><View style={s.ct}><Ionicons name="wallet" size={48} color={LaundryColors.primaryLight} /><Text style={s.t}>Wallet Kurir</Text><Text style={s.st}>Fitur wallet akan segera hadir.</Text></View></View>);
}
