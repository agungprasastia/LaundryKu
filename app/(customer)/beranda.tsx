    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.iconCircle}>
          <Ionicons name="home" size={40} color={LaundryColors.primary} />
        </View>
        <Text style={styles.title}>Beranda Customer</Text>
        <Text style={styles.subtitle}>Fitur customer akan segera hadir di phase selanjutnya.</Text>
      </View>
    </View>
  );
}
