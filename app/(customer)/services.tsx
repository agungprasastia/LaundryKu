  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Ionicons name="shirt" size={48} color={LaundryColors.primaryLight} />
        <Text style={styles.title}>Daftar Layanan</Text>
        <Text style={styles.subtitle}>Fitur layanan akan segera hadir di phase selanjutnya.</Text>
      </View>
    </View>
  );
}
