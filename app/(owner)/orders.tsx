...
export default function OwnerOrdersScreen() {
  return (<View style={s.c}><View style={s.h}><Text style={s.ht}>Pesanan</Text></View><View style={s.ct}><Ionicons name="cube" size={48} color={LaundryColors.primaryLight} /><Text style={s.t}>Kelola Pesanan</Text><Text style={s.st}>Fitur kelola pesanan akan segera hadir.</Text></View></View>);
}
